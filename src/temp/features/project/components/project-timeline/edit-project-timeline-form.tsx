...
type EditProjectTimelineFormProps = {
  projectTimeline: any;
  onCancel?: () => void;
};

export function EditProjectTimelineForm({ projectTimeline, onCancel }: EditProjectTimelineFormProps) {
  const [state, formAction, isPending] = useActionState(
    projectTimelineActions.update,
    initialState
  );
  ...
  return (
    <AppCard title="Edit ProjectTimeline">
      <AppForm
        ...
        submitProps={ {
          ...
          label: "Update ProjectTimeline",
        } }
      >
        <p>Edit form fields for projectTimeline go here.</p>
